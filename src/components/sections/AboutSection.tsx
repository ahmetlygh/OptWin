    ...
    return (
        <section id="about" className="w-full flex flex-col gap-10 mt-12 mb-16 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Card 1 */}
                <div className="bg-[var(--card-bg)]/80 backdrop-blur-sm border border-[var(--border-color)] p-6 rounded-2xl transition-transform hover:-translate-y-1.5 group shadow-lg hover:shadow-[0_15px_30px_rgba(108,92,231,0.1)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-blue-500/10 rounded-full blur-[40px] pointer-events-none group-hover:bg-blue-500/20 transition-colors"></div>
                    <div className="w-12 h-12 rounded-xl bg-blue-500/20 text-blue-400 flex items-center justify-center text-xl mb-4 shadow-inner ring-1 ring-blue-500/50">
                ...
                {/* Card 2 */}
                <div className="bg-[var(--card-bg)]/80 backdrop-blur-sm border border-[var(--border-color)] p-6 rounded-2xl transition-transform hover:-translate-y-1.5 group shadow-lg hover:shadow-[0_15px_30px_rgba(108,92,231,0.1)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-emerald-500/10 rounded-full blur-[40px] pointer-events-none group-hover:bg-emerald-500/20 transition-colors"></div>
                    <div className="w-12 h-12 rounded-xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-xl mb-4 shadow-inner ring-1 ring-emerald-500/50">
                ...
                {/* Card 3 */}
                <div className="bg-[var(--card-bg)]/80 backdrop-blur-sm border border-[var(--border-color)] p-6 rounded-2xl transition-transform hover:-translate-y-1.5 group shadow-lg hover:shadow-[0_15px_30px_rgba(108,92,231,0.1)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-[var(--accent-color)]/10 rounded-full blur-[40px] pointer-events-none group-hover:bg-[var(--accent-color)]/20 transition-colors"></div>
                    <div className="w-12 h-12 rounded-xl bg-[var(--accent-color)]/20 text-[var(--accent-color)] flex items-center justify-center text-xl mb-4 shadow-inner ring-1 ring-[var(--accent-color)]/50">
            ...
            <div className="max-w-3xl mx-auto w-full border border-[var(--border-color)] bg-gradient-to-br from-[var(--card-bg)] to-[#1a182e]/50 rounded-[1.5rem] p-8 md:p-10 shadow-xl relative overflow-hidden flex flex-col items-center text-center gap-5 backdrop-blur-md">
                ...
                <div className="w-16 h-16 rounded-full bg-[var(--accent-color)]/10 text-[var(--accent-color)] flex items-center justify-center text-3xl mb-2 shadow-[0_0_20px_rgba(108,92,231,0.3)]">
                ...
                <a
                    ...
                    className="z-10 mt-2 px-6 py-3 bg-[#FFDD00] hover:bg-[#ffea4d] text-[#000000] font-black tracking-wide rounded-xl transition-all shadow-[0_10px_20px_rgba(255,221,0,0.3)] hover:shadow-[0_15px_30px_rgba(255,221,0,0.4)] hover:-translate-y-1 flex items-center gap-2"
                >
