        ...
        <section id="about" className="w-full flex flex-col items-center gap-10 mt-12 mb-6 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                ...
                <div className="bg-[var(--card-bg)]/80 backdrop-blur-sm border border-[var(--border-color)] p-6 rounded-2xl hover:-translate-y-2 group shadow-lg hover:shadow-[0_20px_40px_rgba(108,92,231,0.15)] relative overflow-hidden transition-all duration-500 cubic-bezier(0.23, 1, 0.32, 1)">
                    ...
                    <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2 tracking-tight">{t["about.safeSecure"]}</h3>
                    <p className="text-[var(--text-secondary)] leading-relaxed text-xs">{t["about.safeSecureDesc"]}</p>
                </div>
                ...
                <div className="bg-[var(--card-bg)]/80 backdrop-blur-sm border border-[var(--border-color)] p-6 rounded-2xl hover:-translate-y-2 group shadow-lg hover:shadow-[0_20px_40px_rgba(108,92,231,0.15)] relative overflow-hidden transition-all duration-500 cubic-bezier(0.23, 1, 0.32, 1)">
                    ...
                    <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2 tracking-tight">{t["about.openSource"]}</h3>
                    <p className="text-[var(--text-secondary)] leading-relaxed text-xs">{t["about.openSourceDesc"]}</p>
                </div>
                ...
                <div className="bg-[var(--card-bg)]/80 backdrop-blur-sm border border-[var(--border-color)] p-6 rounded-2xl hover:-translate-y-2 group shadow-lg hover:shadow-[0_20px_40px_rgba(108,92,231,0.15)] relative overflow-hidden transition-all duration-500 cubic-bezier(0.23, 1, 0.32, 1)">
                    ...
                    <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2 tracking-tight">{t["about.transparent"]}</h3>
                    <p className="text-[var(--text-secondary)] leading-relaxed text-xs">{t["about.transparentDesc"]}</p>
                </div>
            </div>
            ...
            <div id="support" className="w-full max-w-md">
                ...
                >
                    ...
                    <span className="text-xs text-[var(--text-secondary)] relative z-10 max-w-xs">{t["support.description"]}</span>
                </button>
            </div>
        </section>
    );
