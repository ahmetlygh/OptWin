...
export async function Hero() {
    ...
    return (
        <section className="relative flex flex-col w-full rounded-3xl overflow-hidden border border-(--border-color) animate-fade-in-up sm:min-h-[380px] md:min-h-[420px] lg:min-h-[440px]">
            ...
            {/* Overlays */}
            <div className="absolute inset-0 bg-linear-to-r from-[#0d0d12]/95 via-[#0d0d12]/85 to-[#0d0d12]/40 z-1"></div>
            <div className="absolute inset-0 bg-linear-to-t from-[#0d0d12]/80 via-[#0d0d12]/20 to-transparent z-1"></div>
