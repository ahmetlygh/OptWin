...
export default function ErrorBoundary({
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#0a0a10] bg-[radial-gradient(rgba(255,255,255,0.05)_1px,transparent_1px)] bg-size-[24px_24px] overflow-hidden fixed inset-0 z-9999">
            ...
            <div className="relative z-10 w-full max-w-lg mx-4 p-10 bg-[#0f0f18]/90 border border-white/5 rounded-2xl backdrop-blur-xl shadow-2xl text-center animate-fade-in-up">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button
                        onClick={() => reset()}
                        className="w-full sm:w-auto px-8 py-3.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/5 text-white font-bold tracking-wide transition-all flex items-center justify-center gap-2 active:scale-95"
                    >
