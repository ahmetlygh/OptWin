...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        ...
        >
            ...
            <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, ease: "easeOut" }} className="w-full bg-white/2 backdrop-blur-md border border-white/5 rounded-2xl p-4 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {isContentTab && (
                            <div className="flex items-center gap-3 bg-white/4 border border-white/6 rounded-xl px-3 py-1.5">
                ...
                {/* Tab bar — embedded */}
                <div className="flex gap-1 p-1 rounded-xl bg-white/2 border border-white/4 max-w-fit">
                    {TABS.map(tab => {
